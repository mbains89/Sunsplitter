# Sunsplitter ticket queue — tip honesty after 616128b6 (#380)

SOURCE lane@616128b60d5cf4f31cb2a3edfaaf0496b17ba2cd · TASK SUN-DOCS-TIP-HONESTY-6161-01 · MODE docs
...
Lane: `version/0.30.1-main-reconcile-ci.1` at `616128b60d5cf4f31cb2a3edfaaf0496b17ba2cd`
(merge of PR **#380** `SUN-DOCS-TIP-HONESTY-F576-01`).
Ancestry: **#371** @ `0e7535df` then **#377** @ `5d20c123` then **#378** @ `13a45eb5` then **#379** @ `f5766707` then **#380** @ `616128b6`.
...
`docs/SUN_DOCS_TIP_HONESTY_F576.md`,
...
This pass receipt: `docs/SUN_DOCS_TIP_HONESTY_6161.md`.
...
| Id | State |
|---|---|
| `version/0.30.1-main-reconcile-ci.1` | Active write lane. Tip `616128b60d5cf4f31cb2a3edfaaf0496b17ba2cd` after PR **#380**. |
| PR **#380** `SUN-DOCS-TIP-HONESTY-F576-01` | Merged. Pointed STATUS/QUEUE at `f5766707`. Historical once this pass lands. |
...
`SUN-DOCS-TIP-HONESTY-F576-01` PR **#380**.
