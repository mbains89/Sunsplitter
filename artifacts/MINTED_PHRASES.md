...
**Last verified against build:** v0.27.2  
...
| If the vault and the living need the same mercy, the living get it. | Tomas | prom_make_tomas + custody_after quote-back | 0.27 | Contract-class. |
