...
// 0.28.2 size hygiene. Pure mechanical. mid-a: arc_living_1 + living_2
...
registerScenes({
  ...
  arc_living_2: {
    get text() {
      ...
      if (isAlive("sela")) {
        ...
        if (isAlive("jiro")) {
          ...
          t += `"They think I am mourning. They are half right. The other half is refusal. If we only optimize for what survives the dark, we will arrive as the dark."\n\n`;
        }
    ...
    get image() {
      return isAlive("sela") ? "images/sela.jpg" : "images/corridor.jpg";
    }
  },
